    const Objects_En =
    {
        ...
        "Footer":  
            {
              "text":"\u00A9 2023 Jeisson .J. Sánchez Castellanos. All rights reserved.",
              "Buttons" : {
                  "btn1" : "English",
                  "btn2" : "Spanish",
                  "btn3": "German"
        ...
        "About":
            {
                ...
                "hobbies":{
                    ...
                    "hobbieThree": {
                        "name":"encierro",
                        "description": "Lgsus Lettering is a youtube channel created to share some artistic works that he did in times of pandemic, many of them made with brush tip markers"
                    }
                }
            },
        "Projects":
            {
                ...
                "projectThree":{
                    "name": "Mokepon",
                    "description": "This is my first project, it's a simple arrangement using html, javascript and css to form a minigame that uses rock paper scissors logical reasoning but with earth, water and fire."
                },
                "projectFour":{
                    "name": "Rick & Morty",
